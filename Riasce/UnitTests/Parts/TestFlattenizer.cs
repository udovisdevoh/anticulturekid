    ...
    class TestFlattenizer
    {
        ...
        private static void TestFlattenizerGeneralStuff()
        {
            ...
            */
            ...
            Proof testProof;
            testProof = new Proof();
            testProof.AddArgument(new Proposition(mother, make, child));
            if (mother.GetFlatConnectionBranch(lovedby).GetProofTo(child) != testProof)
                throw new Exception("Proof should match");

            testProof = new Proof();
            testProof.AddArgument(new Proposition(child, madeby, mother));
        ...
        private static void TestDoubleSidedLove()
        {
            ...
            expectedProof1.AddArgument(new Proposition(me, love, you));
            expectedProof1.AddArgument(new Proposition(you, love, me));

            Proof expectedProof2 = new Proof();
            expectedProof2.AddArgument(new Proposition(you, love, me));
            expectedProof2.AddArgument(new Proposition(me, love, you));
