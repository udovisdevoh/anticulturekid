...
namespace AntiCulture.Kid
{
    ...
    public class NameMapper : IEnumerable<string>
    {
        ...
        {
            Misc.Argument.Ensure(conceptName, "concept name");
        ...
        {
            Misc.Argument.Ensure(conceptId, "concept id");
        ...
        {
            Misc.Argument.Ensure(oldConceptName, "old concept name");
            Misc.Argument.Ensure(newConceptName, "new concept name");
        ...
        public void AddAlias(string newNameForConcept, string existingNameForConcept)
        {
            ...
            Misc.Argument.Ensure(newNameForConcept, "new name for concept");
            Misc.Argument.Ensure(existingNameForConcept, "existing name for concept");
        ...
        {
            Misc.Argument.Ensure(concept1Name, "concept 1 name");
            Misc.Argument.Ensure(concept2Name, "concept 2 name");
