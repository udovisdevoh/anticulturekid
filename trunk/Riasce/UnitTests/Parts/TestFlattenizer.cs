    ...
    class TestFlattenizer
    {
        ...
        private static void TestFlattenizerGeneralStuff()
        {
            ...
            */
            ...
            Proof testProof;
            testProof = new Proof();
            testProof.AddArgument(Argument.Build(mother, make, child));
            if (mother.GetFlatConnectionBranch(lovedby).GetProofTo(child) != testProof)
                throw new Exception("Proof should match");

            testProof = new Proof();
            testProof.AddArgument(Argument.Build(child, madeby, mother));
        ...
        private static void TestDoubleSidedLove()
        {
            ...
            expectedProof1.AddArgument(Argument.Build(me, love, you));
            expectedProof1.AddArgument(Argument.Build(you, love, me));

            Proof expectedProof2 = new Proof();
            expectedProof2.AddArgument(Argument.Build(you, love, me));
            expectedProof2.AddArgument(Argument.Build(me, love, you));
