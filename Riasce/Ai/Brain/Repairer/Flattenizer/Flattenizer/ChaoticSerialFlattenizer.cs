                        ...
                        subject != complement)
                    {
                        ...
                        if (subject.GetFlatConnectionBranch(directlyImpliedVerb).GetProofTo(complement).Count > 0)
                        {
                            ...
                            if (verb != directlyImpliedVerb)
                                flatBranch.GetProofTo(complement).AddArgument(new Proposition(subject, directlyImpliedVerb, complement));
                        }
                        else
                        {
                            if (verb != directlyImpliedVerb)
                            ...
                            subject != metaComplement)
                        {
                            ...
                            else
                            {
                                if (complement != metaComplement)
                                    flatBranch.GetProofTo(metaComplement).AddArgument(new Proposition(subject, verb, complement));
                            }
                            ...
                            {
                                if (verb != liffidVerb)
                                    flatBranch.GetProofTo(metaComplement).AddArgument(new Proposition(complement, liffidVerb, metaComplement));
                            }
                            ...
                            subject != metaComplement)
                        {
                            ...
                            else
                            {
                                if (verb != muctVerb || complement != metaComplement)
                                    flatBranch.GetProofTo(metaComplement).AddArgument(new Proposition(subject, muctVerb, complement));
                            }
                            ...
                            else
                            {
                                ...
                                {
                                    flatBranch.GetProofTo(metaComplement).AddArgument(new Proposition(complement, verb, metaComplement));
                                }
                            }
